...
| 题库（题目） | **v3.2** | `docs/type-eval.md` 成绩单（沿革见 git 提交记录） |
...
- 暖纸编辑风视觉（v2 换肤）：陶土色单一强调色 + 羊皮纸底 + 纸纹、报告头部阳面四功能徽章（英雄→阿尼玛四档浓度）、衬线/楷体标题层级、8pt 间距网格（皮肤规范为本地第三方 skill `docs/design-skill`）
...
| 封面 | 答题页 | 报告揭晓 |
|---|---|---|
| ![封面](docs/screenshots/封面.png) | ![答题页](docs/screenshots/答题页.png) | ![报告揭晓](docs/screenshots/报告揭晓.png) |

> 截图取自线上版本。`design-previews/` 放着设计过程稿（本地，不进仓库）。
